...
export default async function SmartGoalsArticle({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  const fileByLocale: Record<string, string> = {
    en: join(process.cwd(), "content/blog/smart-goals/en.md"),
    zh: join(process.cwd(), "content/blog/smart-goals/zh.md"),
    es: join(process.cwd(), "content/blog/smart-goals/es.md"),
    fr: join(process.cwd(), "content/blog/smart-goals/fr.md"),
    de: join(process.cwd(), "content/blog/smart-goals/de.md"),
  };
