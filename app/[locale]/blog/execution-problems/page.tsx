...
export default async function ExecutionProblemsArticle({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  const fileByLocale: Record<string, string> = {
    en: join(process.cwd(), "content/blog/execution-problems/en.md"),
    zh: join(process.cwd(), "content/blog/execution-problems/zh.md"),
    es: join(process.cwd(), "content/blog/execution-problems/es.md"),
    fr: join(process.cwd(), "content/blog/execution-problems/fr.md"),
    de: join(process.cwd(), "content/blog/execution-problems/de.md"),
  };
