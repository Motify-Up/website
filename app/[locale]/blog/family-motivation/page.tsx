...
export default async function FamilyMotivationArticle({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  const fileByLocale: Record<string, string> = {
    en: join(process.cwd(), "content/blog/family-motivation/en.md"),
    zh: join(process.cwd(), "content/blog/family-motivation/zh.md"),
    es: join(process.cwd(), "content/blog/family-motivation/es.md"),
    fr: join(process.cwd(), "content/blog/family-motivation/fr.md"),
    de: join(process.cwd(), "content/blog/family-motivation/de.md"),
  };
