...
export default async function SelfDisciplineArticle({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  const fileByLocale: Record<string, string> = {
    en: join(process.cwd(), "content/blog/self-discipline/en.md"),
    zh: join(process.cwd(), "content/blog/self-discipline/zh.md"),
    es: join(process.cwd(), "content/blog/self-discipline/es.md"),
    fr: join(process.cwd(), "content/blog/self-discipline/fr.md"),
    de: join(process.cwd(), "content/blog/self-discipline/de.md"),
  };
